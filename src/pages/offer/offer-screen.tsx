            ...
            <div className="offer__wrapper">
              ...
              <section className="offer__reviews reviews">
                ...
                <ul className="reviews__list">
                  ...
                  {/* Тут короче надо думать, как получить id конкретного оффера, чтобы в массиве всех комметарией найти только необходимые по айди (ну и что брать в качестве key для компонента комментария) */}
                </ul>
                <CommentFormScreen />
              </section>
            </div>
